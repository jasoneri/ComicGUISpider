...
2. 更新程序使用的api速率限制为一小时60个请求，简单来说就是长时间没更新，导致需更新的commit过多时，网络原因加上重试很大可能导致更新失败被禁一小时
3. 基于第2点，当前解决方法是开发这边最多不超过10个commit会更新一次release，一句话就是 _**平时不习惯用更新程序，一看离标题时间间隔又过长的时候，直接下最新绿色包覆盖再使用更新程序即可**_

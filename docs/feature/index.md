...
|  |  [拷贝](https://www.mangacopy.com/) |    [Māngabz](https://mangabz.com)     | [禁漫](https://18comic.vip/) |    [wnacg](https://www.wnacg.com/)    | [ExHentai](https://exhentai.org/) |
|:--------------------------------------|:-------------:|:---------:|:----:|:----------:|:----------:|
| 预览 | ❌ |     ❌ | ✔️ | ✔️ | ✔️ |
| 翻页 | ✔️ |     ✔️ | ✔️ | ✔️ | ✔️<br>禁跳页 |
| 工具箱-读剪贴板 | ❌ | ❌ | ✔️ | ✔️ | ✔️ |
...
win: [🌐Ditto](https://github.com/sabrogden/Ditto)、macOS: [🌐Maccy](https://github.com/p0deje/Maccy)。  

...
::: tip 用 `KILO CODE`, 配置提供商选 `OpenAI Compatible`, 基础URL: `{站点api}/v1`
:::

- [随时跑路公益站](https://runanytime.hxi.me/register?aff=81Nu)
- [黑与白公益站](https://ai.hybgzs.com/register?aff=cyW1) 关注[欧阳淇淇的话题贴](https://linux.do/u/ouyangqiqi/activity/topics)(注册有级别门槛)
- [莹のAPI](https://api.wpgzs.top/register?aff=GzNG) 令牌分组选`codes`!!

...
+ danbooru 新增 单细胞生物也能轻松出图 的 comfy tag 生成流，使用的 ANIMA 模型，具体[参阅文档](https://cgs.101114105.xyz/script/danbooru#tag-%E5%AF%BC%E5%87%BA%E9%9D%A2%E6%9D%BF)

<details>
<summary> 图片效果预览 </summary>

![pic1](https://img-cgs.101114105.xyz/file/screenshots/1786036159569_python_C9b2t2BiGR.png)
![pic2](https://img-cgs.101114105.xyz/file/screenshots/1786036429293_python_khMo4k8CXN.jpg)
[nsfw-pic3](https://img-cgs.101114105.xyz/file/screenshots/1786123141590_python_p9EY6glJ7A.jpg)

</details>

+ danbooru 瀑布流新增右下分页导航悬浮
...
+ danbooru 若干交互修复
+ wnacg 代理不受国内域名影响修复，进度条跟进修复，✨ 图链修复
+ ✨ jm 访问修复
+ nh 的启动探针环境测试修复，jestful 封面加载修复
+ dm5 图源下载优化
+ 修复 jcomic 图源下载
+ ✨ 优化预处理取消后不再阻塞；优化 scriptWin 进入；优化启动
+ ✨ danbooru 输入框联想选择回车优化
+ 优化 win int 的更新相关
+ aria2 二进制改存用户配置目录
+ `C108` , on! (更新了默认)
...
+ 加入 搜索/翻页/提交任务的 Loader ，优化内置浏览器的等待体感
+ danbooru tag 管理面板新增 ai 后台翻译 tag 功能
...
+ Danbooru 分页标识,视频标识,已收藏标识等
+ hitomi/Script(Kemono)/nhentai 预处理改为 ci raleases/preset生成，使用时下载（带进度反馈）
+ 优化 scriptWin 的进入条件

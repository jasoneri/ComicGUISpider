...
:::
::: warning macOS 由于认证签名收费，app 初次打开会有限制，正确操作如下
...
| 2   | 打开终端执行 初始化/环境 更新命令，<br>`bash /Applications/CGS.app/Contents/Resources/scripts/deploy/launcher/mac/init.bash`<br/>⚠️ _**根据提示操作**_ （对应第1.5步改字体可以反复执行第2步） |

    ...
    themeConfig: {
        ...
        socialLinks: [
            {icon: {
                ...
                }, link: "https://github.com/jasoneri/ComicGUISpider"},
            {
                icon: {
            ...
            },
            {
                ...
                link: "https://discord.gg/BRx5xPpEYe"
            },
        ],
        nav: [
        ...
        footer: {
            message: `ComicGUISpider Released under the MIT License. (latest: ${version})`,
            copyright: 'Copyright © 2024-present @jasoneri & ComicGUISpider Contributors',
        },
        sidebar: [
            {
                items: [

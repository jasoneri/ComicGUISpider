...
class MitmMainWindow(Ui_MainWindow):
    ...
    def apply_translations(self):
        ...
        self.loginBtn = TransparentToolButton(CgsIcon.MAIN_LOGIN, self)
        self.loginBtn.setVisible(False)
        self.loginBtn.setIconSize(QtCore.QSize(24, 24))
        self.loginBtn.setStatusTip(_translate("MainWindow", "loginBtnStatusTip"))
        self.horizontalLayout_3.insertWidget(1, self.loginBtn)

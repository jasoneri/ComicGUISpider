...
class MitmMainWindow(Ui_MainWindow):
    def setupUi(self, _mainWindow):
        ...
        self.searchinput.setInputMask(_translate("MainWindow", f"{res.searchinputPrefix}{'x'*50}"))
        self.searchinput.setText(_translate("MainWindow", res.searchinputPrefix))
        self.chooseinput.setInputMask(_translate("MainWindow", f"{res.chooseinputPrefix}{'#'*80}"))
        self.chooseinput.setText(_translate("MainWindow", res.chooseinputPrefix))

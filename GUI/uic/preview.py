...
class Ui_preview(object):
    def setupUi(self, preview):
        ...
        preview.resize(1040, 500)
        preview.setMinimumSize(QtCore.QSize(1040, 417))
        preview.setMaximumSize(QtCore.QSize(1375, 16777215))
        icon = QtGui.QIcon()
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/chevron_left_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/right_arrow_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/refresh_ccw_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, preview):
        ...
        preview.setWindowTitle(_translate("preview", "预览"))
        self.topHintBox.setText(_translate("preview", "窗口置顶"))
        self.homeBtn.setToolTip(_translate("preview", "回到初始页"))
        self.homeBtn.setText(_translate("preview", "..."))
        self.backBtn.setToolTip(_translate("preview", "后退"))
        self.backBtn.setText(_translate("preview", "..."))
        self.forwardBtn.setToolTip(_translate("preview", "前进"))
        self.forwardBtn.setText(_translate("preview", "..."))
        self.refreshBtn.setToolTip(_translate("preview", "刷新页面"))
        self.refreshBtn.setText(_translate("preview", "..."))
        self.ensureBtn.setText(_translate("preview", "确认选择"))

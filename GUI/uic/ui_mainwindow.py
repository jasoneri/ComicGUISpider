...
"}")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/reboot_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.retrybtn.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/help_btn.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.previewBtn.setIcon(icon7)
...
"}")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/crawl_btn.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.crawl_btn.setIcon(icon8)

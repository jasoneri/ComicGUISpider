...
class Ui_browser(object):
    def setupUi(self, browser):
        ...
        self.cookieSvBtn = QtWidgets.QToolButton(self.ehentaiWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cookieSvBtn.sizePolicy().hasHeightForWidth())
        self.cookieSvBtn.setSizePolicy(sizePolicy)
        self.cookieSvBtn.setMinimumSize(QtCore.QSize(0, 0))
        self.cookieSvBtn.setMaximumSize(QtCore.QSize(28, 16777215))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        font.setWeight(75)
        self.cookieSvBtn.setFont(font)
        self.cookieSvBtn.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/save_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cookieSvBtn.setIcon(icon6)
        self.cookieSvBtn.setIconSize(QtCore.QSize(25, 25))
        self.cookieSvBtn.setToolButtonStyle(QtCore.Qt.ToolButtonIconOnly)
        self.cookieSvBtn.setAutoRaise(True)
        self.cookieSvBtn.setObjectName("cookieSvBtn")
        self.horizontalLayout_ehentai.addWidget(self.cookieSvBtn)
        ...
        self.ensureBtn.setStyleSheet("QToolButton {\n"
                                     ...
                                     "}")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/download_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, browser):
        ...
        self.cookieSvBtn.setToolTip(_translate("browser", "save cookies/保存登录状态"))

...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.sv_pathEdit = LineEdit(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.eh_cookiesEdit = TextEdit(Dialog)
...
"}")
        ...
        self.bottom_btn_horizontalLayout.addWidget(self.buttonBox)
        self.gridLayout_2.addLayout(self.bottom_btn_horizontalLayout, 7, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.addUuid.setText(_translate("Dialog", "增加标识"))
        ...
        self.eh_cookiesEdit.setPlaceholderText(_translate("Dialog", "cookies field key/cookies字段名  igneous,ipb_member_id,ipb_pass_hash"))

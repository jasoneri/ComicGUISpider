...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMaximumSize(QtCore.QSize(650, 680))
        icon = QtGui.QIcon()
        ...
        self.horizontalLayout_label_cookies = QtWidgets.QHBoxLayout()
        self.horizontalLayout_label_cookies.setObjectName("horizontalLayout_label_cookies")
        ...
        self.horizontalLayout_label_cookies.addLayout(self.verticalLayout_3)
        self.cookiesEdit = TextEdit(Dialog)
        self.cookiesEdit.setObjectName("cookiesEdit")
        self.horizontalLayout_label_cookies.addWidget(self.cookiesEdit)
        self.dialogVLayout.addLayout(self.horizontalLayout_label_cookies)
        ...
        self.dialogVLayout.addLayout(self.expandLayout)

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(700, 635)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(700, 635))
        MainWindow.setMaximumSize(QtCore.QSize(1150, 730))
...
">_<"))
        ...
        self.progressBar.setToolTip(_translate("MainWindow", " ……悲哀，难啊(Ｔ▽Ｔ)"))
        self.progressBar.setStatusTip(_translate("MainWindow", " ……进度条简读① 进度条蓝色表示后台还在下载中（ 页数太多时会卡在97% ） ② 绿色100%表示完成"))

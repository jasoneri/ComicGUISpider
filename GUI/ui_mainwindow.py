...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chooseBox.setItemText(3, _translate("MainWindow", "3、joyhentai**"))
...
">_<"))
        ...
        self.progressBar.setToolTip(_translate("MainWindow", " …… 它下得慢我也无计 (Ｔ▽Ｔ)"))
        self.progressBar.setStatusTip(
            _translate("MainWindow", " ……进度条简读 Ⅰ、进度条蓝色表示后台还在下载中（ 有时进度条会回跳的无视无视，以颜色为准 ） Ⅱ、 绿色100%表示完成"))
